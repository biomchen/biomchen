...
* ⚡ Highlighted Projects
  * One-stop ChatBot implementation using **CoT**, **RAG**, and **Relational DB** (NLU, GenAI)
  * Knowledge Graph implementation of the RAG (GenAI)
...
#### Skills
[![Skills](https://skillicons.dev/icons?i=py,mysql,pytorch,aws,azure,gcp,jenkins,flask,fastapi,git,vscode,docker,django,r,react)](https://skillicons.dev)
...
* 🖥️ You can find me at [LinkedIn](https://www.linkedin.com/in/mlchen/)  
